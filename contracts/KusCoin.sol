...
contract KusCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KusCoin() {
        ...
        name = "KusCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KUS";                                             // Set the symbol for display purposes (CHANGE THIS)
